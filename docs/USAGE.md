...
The campaign creates or resumes local branch `improve/repository-hardening`, committing `dev/improve/repository-hardening/campaign.md` at start. Each iteration chains planning and execution workflows in fresh contexts while keeping the orchestrating session lean:
