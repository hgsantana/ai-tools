> Shared workflow for `/update-ai-tools`, `/remove-ai-tools`, and `/reinstall-ai-tools`. Not installed. The dispatching skill names the **Task**. This file is the source; edit it.
