...
description: >
  ...
  request) through the plan-ai-tools and dev-ai-tools agents. Use for
...
Refining a demand into a story and delivering it end to end through the shipped `plan-ai-tools` and `dev-ai-tools` agents, in this session, on whatever model it provides.
