...
description: >
  ...
  under dev/, then stop, never implementing — either by dispatching the plan-ai-tools agent or by
  running its base file in this session. Use for /plan-ai-tools or whenever a non-trivial change
