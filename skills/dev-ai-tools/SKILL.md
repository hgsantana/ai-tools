...
description: >
  ...
  brief, unattended — either by dispatching the dev-ai-tools agent or by running its base file
  in this session. Use for /dev-ai-tools or after the user accepts a plan.
...
Your base file is `$HOME/.ai-tools/skills/dev-ai-tools.md`.
