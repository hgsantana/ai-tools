...
name: gh-ai-tools
description: >
  Run the gh-ai-tools work — query or manage GitHub via the GitHub CLI (gh) — by dispatching
  planner-ai-tools to follow this skill. Use for /gh-ai-tools or whenever the user asks about GitHub
